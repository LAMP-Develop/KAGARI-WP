...
<div class="input-group-text bg-white border-right-0 py-0 pr-0">
...
<input name="s" type="text" class="form-control border-left-0" placeholder="キーワードで検索">
</div>
</form>
</div>
<!-- カテゴリー -->
...
<a href="<?php echo $home; ?>/blog/" class="text-dark list-group-item">全ての記事</a>
<?php
$args = [
    'orderby' => 'id',
    'order' => 'asc',
...
?>
<a href="<?php echo $cat_link; ?>" class="text-dark list-group-item"><?php echo $cat_name; ?></a>
<?php endforeach; ?>
</div>
</div>
