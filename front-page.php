...
<a href="<?php echo $home; ?>/product/">もっと詳しく<i class="fas fa-chevron-right ml-2"></i></a>
</div>
</div>
</div>
</div>
...
<div class="row justify-content-lg-start justify-content-md-center mt-md-5 mt-4 mx-0">
...
<div class="col-lg-5 col-md-4 text-md-center p-0 mt-md-0 mt-3">
<a href="https://kagari.ai/report-demo/pdf/kagari-reports.pdf" target="_blank" class="btn btn-outline-primary"><i class="fas fa-arrow-alt-circle-down mr-2"></i>サンプルをダウンロード</a>
</div>
</div>
</div>
...
<div class="row mx-0">
<div class="col-md bg-white rounded-lg py-5 px-md-4 text-center mb-md-0 mb-3">
<div class="mb-3">
...
<div class="col-md bg-white rounded-lg py-5 px-md-4 mx-md-4 text-center mb-md-0 mb-3">
<div class="mb-3">
