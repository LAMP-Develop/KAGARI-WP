...
<div class="card-title">
<h3 class="text-dark font-weight-bold">改善施策をAIが自動で提案</h3>
</div>
<p class="card-text m-0">数多くのサイトの解析を手掛けたノウハウに基づいて、的確な改善施策をAIが自動で提案します。AIの総括コメントと提案が自動で入力されるので、そのまま印刷して報告業務にご利用いただけます。</p>
</div>
</div>
<div class="col-md-5 text-center p-md-4 p-3">
...
<div class="col-md bg-white border rounded-lg p-md-4 p-3 mx-md-3">
<div class="d-flex justify-content-start align-items-stretch">
<div class="mr-3">
